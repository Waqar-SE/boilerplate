...
function Login() {
  return (
    <div className="grid min-h-svh lg:grid-cols-2">
      <div className="flex flex-col justify-center items-center bg-gray-100 space-y-10">
        <h1 className="text-6xl font-semibold">
          <div className="bg-primary text-primary-foreground flex items-center justify-center rounded-md inline-block p-1 me-1">
        ...
        <div className="text-center">
          <p className="text-center">
            <span className="font-bold">Tech Stack</span> <br /> Django, DRF,
            React and Vite.
          </p>
          <p>
            Maintainer: <span className="italic font-semibold">Waqar Ali</span>
          </p>
        </div>
        <div className="text-center">
          ...
          <div className="flex">
            ...
            <a
              href="https://github.com/Waqar-SE"
              target="_blank"
              rel="noreferrer"
            >
              <svg
            ...
            <a href="mailto:waqar_se@outlook.com">
              <img
                width="100"
                height="100"
